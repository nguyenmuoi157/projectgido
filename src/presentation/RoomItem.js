...
export default class RoomItem extends React.PureComponent {
	...
	render() {
		const {
			favorite, alert, unread, userMentions, name, _updatedAt,lastMessage
		} = this.props;
		...
		return (
			<TouchableHighlight onPress={this.props.onPress} underlayColor='#FFFFFF' activeOpacity={0.5} accessibilityLabel={accessibilityLabel} accessibilityTraits='selected'>
				<View style={[styles.container, favorite && styles.favorite]}>
					...
					<View style={styles.roomNameView}>
						...
						<Text style={styles.update} ellipsizeMode='tail' numberOfLines={1}>{ lastMessage }</Text>
					</View>
